...
// Inverted pyramid: 12 -> 11 -> 10 -> 9 -> 8 -> 5
// Row sizes are capped at 12: the container is 1000px wide and each item
// renders at 73px (55px content-box + 16px padding + 2px border) with a
// 10px gap, so 13+ items on one row wraps and breaks the pyramid shape.
const techStack: TechItem[][] = [
  ...
  [
    ...
    { name: "MLflow", icon: "https://cdn.simpleicons.org/mlflow", url: "https://mlflow.org" },
  ...
  [
    ...
    { name: "GitHub Actions", icon: "https://cdn.jsdelivr.net/gh/devicons/devicon/icons/githubactions/githubactions-plain.svg", url: "https://github.com/features/actions" },
  ...
  [
    ...
    { name: "TensorFlow Serving", icon: "https://cdn.jsdelivr.net/gh/devicons/devicon/icons/tensorflow/tensorflow-original.svg", url: "https://www.tensorflow.org/tfx/guide/serving" },
    ...
    { name: "REST APIs", icon: "https://img.icons8.com/color/48/api-settings.png", url: "https://en.wikipedia.org/wiki/REST" },
    { name: "CNNs", icon: "https://img.icons8.com/color/48/artificial-intelligence.png", url: "https://en.wikipedia.org/wiki/Convolutional_neural_network" },
  ...
  // Row 6 - 5 items (tip of pyramid)
  [
    { name: "Hugging Face", icon: "https://huggingface.co/front/assets/huggingface_logo-noborder.svg", url: "https://huggingface.co" },
    { name: "Claude", icon: "https://cdn.simpleicons.org/anthropic", url: "https://www.anthropic.com/claude" },
    { name: "Gemini", icon: "https://cdn.simpleicons.org/googlegemini", url: "https://gemini.google.com" },
    { name: "Recommender Systems", icon: "https://img.icons8.com/color/48/filter.png", url: "https://en.wikipedia.org/wiki/Recommender_system" },
